...
interface CreateWorkspaceTabbedProps {
  phase: string
...
export function CreateWorkspaceTabbed({ phase, onPhaseChange }: CreateWorkspaceTabbedProps) {
  ...
  const formView = (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <PageSection variant={PageSectionVariants.default}>
        <Form onSubmit={handleSubmit} style={{ maxWidth: mode === 'repo' ? 700 : undefined }}>
          <Tabs
            activeKey={mode}
          ...
          <div style={{ maxWidth: mode === 'template' ? 700 : undefined, display: 'flex', flexDirection: 'column', gap: 'var(--pf-t--global--spacer--lg)' }}>
          <FormGroup
